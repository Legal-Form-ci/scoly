...
export const translations: Record<Language, Translations> = {
  fr: {
    nav: {
      easyClass: "Scoly",
      secondary: "Journal",
      secondaryDesc: "Articles et publications",
      university: "Journal",
    ...
    hero: {
      ...
      demo: "Lire le Journal",
      secondaryTitle: "Journal Scoly",
      secondaryDesc: "Articles et publications éducatives",
    ...
    spaces: {
      title: "Tout pour votre réussite scolaire",
      subtitle: "Scoly vous offre des produits de qualité et des ressources éducatives pour accompagner votre parcours.",
      secondary: {
      ...
      university: {
        title: "Journal Scoly",
        description: "Un espace dédié aux publications éducatives. Découvrez des articles, ouvrages et guides pour accompagner votre apprentissage.",
        features: [
          "Articles éducatifs",
          "Ouvrages et guides",
          "Contenus premium",
  ...
  en: {
    nav: {
      easyClass: "Scoly",
      secondary: "Journal",
      secondaryDesc: "Articles and publications",
      university: "Journal",
    ...
    hero: {
      ...
      demo: "Read the Journal",
      secondaryTitle: "Scoly Journal",
      secondaryDesc: "Educational articles and publications",
    ...
    spaces: {
      ...
      university: {
        title: "Scoly Journal",
        description: "A space dedicated to educational publications. Discover articles, books and guides to support your learning.",
        features: [
