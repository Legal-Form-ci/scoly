...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    spaces: {
      ...
      subtitle: "Izy-scoly vous offre des produits de qualité et des ressources éducatives pour accompagner votre parcours.",
      secondary: {
      ...
      university: {
        ...
        description: "Un espace dédié aux actualités scolaires et bureautiques. Découvrez les taux de réussite, résultats d'examens et informations éducatives.",
        features: [
