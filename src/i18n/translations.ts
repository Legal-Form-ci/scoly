...
export const translations: Record<Language, Translations> = {
  fr: {
    nav: {
      easyClass: "Scoly",
      secondary: "Vendeurs",
      secondaryDesc: "Espace vendeurs partenaires",
      university: "Journal",
      universityDesc: "Articles et publications",
    ...
    hero: {
      badge: "La marketplace #1 de fournitures en Côte d'Ivoire",
      title1: "Fournitures scolaires",
      title2: "et bureautiques en un seul clic",
      subtitle: "Scoly connecte vendeurs et acheteurs pour les fournitures scolaires et bureautiques. Commandez, payez et faites-vous livrer facilement.",
      cta: "Découvrir la boutique",
      demo: "Devenir vendeur",
      secondaryTitle: "Marketplace",
      secondaryDesc: "Achetez directement auprès des vendeurs",
      universityTitle: "Journal Scoly",
      universityDesc: "Articles et publications éducatives",
      shopTitle: "Boutique Scoly",
      shopDesc: "Livres et fournitures scolaires",
    },
    spaces: {
      title: "Une plateforme, plusieurs services",
      subtitle: "Découvrez tous les services Scoly pour les fournitures scolaires et bureautiques.",
      secondary: {
        title: "Marketplace Vendeurs",
        description: "Connectez-vous directement avec des vendeurs vérifiés de fournitures scolaires et bureautiques. Comparez les prix et choisissez les meilleurs produits.",
        features: [
          "Vendeurs vérifiés",
          "Prix compétitifs",
          "Large catalogue",
      ...
      university: {
        title: "Journal Scoly",
        description: "Un espace dédié aux publications éducatives. Auteurs, enseignants et chercheurs partagent leurs articles, ouvrages et guides.",
        features: [
          "Articles éducatifs",
          "Ouvrages et guides",
          "Contenus premium",
      ...
      shop: {
        ...
        description: "Tous vos livres et fournitures scolaires et bureautiques en un seul endroit. Livraison partout en Côte d'Ivoire.",
        features: [
    ...
    about: {
      ...
      missionText: "Connecter les vendeurs de fournitures scolaires et bureautiques avec les clients en Côte d'Ivoire à travers une marketplace moderne et efficace.",
      vision: "Notre vision",
      visionText: "Devenir la plateforme de référence pour les fournitures scolaires et bureautiques en Côte d'Ivoire et en Afrique de l'Ouest.",
      values: "Nos valeurs",
      team: "Notre équipe",
  ...
  en: {
    nav: {
      easyClass: "Scoly",
      secondary: "Vendors",
      secondaryDesc: "Partner vendor space",
      university: "Journal",
      universityDesc: "Articles and publications",
      easyScolaire: "Shop",
      about: "About",
      contact: "Contact",
      login: "Login",
    ...
    hero: {
      badge: "The #1 supplies marketplace in Ivory Coast",
      title1: "School and office",
      title2: "supplies in one click",
      subtitle: "Scoly connects vendors and buyers for school and office supplies. Order, pay and get delivered easily.",
      cta: "Discover the shop",
      demo: "Become a vendor",
      secondaryTitle: "Marketplace",
      secondaryDesc: "Buy directly from vendors",
      universityTitle: "Scoly Journal",
      universityDesc: "Educational articles and publications",
      shopTitle: "Scoly Shop",
      shopDesc: "Books and school supplies",
    },
    spaces: {
      title: "One platform, multiple services",
      subtitle: "Discover all Scoly services for school and office supplies.",
      secondary: {
        title: "Vendor Marketplace",
        description: "Connect directly with verified school and office supply vendors. Compare prices and choose the best products.",
        features: [
          "Verified vendors",
          "Competitive prices",
          "Wide catalog",
      ...
      university: {
        title: "Scoly Journal",
        description: "A space dedicated to educational publications. Authors, teachers and researchers share their articles, books and guides.",
        features: [
  ...
  de: {
    nav: {
      easyClass: "Scoly",
      secondary: "Verkäufer",
      secondaryDesc: "Partner-Verkäuferbereich",
      university: "Journal",
      universityDesc: "Artikel und Publikationen",
      easyScolaire: "Shop",
      about: "Über uns",
      contact: "Kontakt",
      login: "Anmelden",
    ...
    hero: {
      ...
      subtitle: "Scoly verbindet Verkäufer und Käufer für Schul- und Bürobedarf. Bestellen, bezahlen und liefern lassen – ganz einfach.",
      cta: "Shop entdecken",
      demo: "Verkäufer werden",
      secondaryTitle: "Marktplatz",
      secondaryDesc: "Kaufen Sie direkt von Verkäufern",
      universityTitle: "Scoly Journal",
      universityDesc: "Bildungsartikel und Publikationen",
      shopTitle: "Scoly Shop",
      shopDesc: "Bücher und Schulmaterialien",
    },
    spaces: {
      title: "Eine Plattform, mehrere Dienste",
      subtitle: "Entdecken Sie alle Scoly-Dienste für Schul- und Bürobedarf.",
      secondary: {
        title: "Verkäufer-Marktplatz",
        ...
        cta: "Verkäufer ansehen",
      },
      university: {
        title: "Scoly Journal",
        description: "Ein Bereich für Bildungspublikationen. Autoren, Lehrer und Forscher teilen ihre Artikel, Bücher und Leitfäden.",
        features: [
          "Bildungsartikel",
  ...
  es: {
    nav: {
      easyClass: "Scoly",
      secondary: "Vendedores",
      secondaryDesc: "Espacio de vendedores asociados",
      university: "Diario",
      universityDesc: "Artículos y publicaciones",
      easyScolaire: "Tienda",
      about: "Acerca de",
      contact: "Contacto",
    ...
    hero: {
      ...
      subtitle: "Scoly conecta vendedores y compradores de materiales escolares y de oficina. Pide, paga y recibe fácilmente.",
      cta: "Descubrir la tienda",
      demo: "Convertirse en vendedor",
      secondaryTitle: "Marketplace",
      secondaryDesc: "Compra directamente de los vendedores",
      universityTitle: "Diario Scoly",
      universityDesc: "Artículos y publicaciones educativas",
      shopTitle: "Tienda Scoly",
      shopDesc: "Libros y materiales escolares",
    },
    spaces: {
      title: "Una plataforma, múltiples servicios",
      subtitle: "Descubre todos los servicios de Scoly para materiales escolares y de oficina.",
      secondary: {
      ...
      university: {
        title: "Diario Scoly",
        description: "Un espacio dedicado a publicaciones educativas. Autores, profesores e investigadores comparten sus artículos, libros y guías.",
        features: [
