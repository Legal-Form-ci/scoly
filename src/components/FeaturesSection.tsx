...
const FeaturesSection = () => {
  ...
  const texts = {
    fr: {
      ...
      journalDesc: "Articles éducatifs et ressources pédagogiques de qualité.",
    ...
    en: {
      ...
      journalDesc: "Quality educational articles and pedagogical resources.",
    ...
    de: {
      ...
      journal: "Scoly Journal",
      journalDesc: "Qualitätsbildungsartikel und pädagogische Ressourcen.",
    ...
    es: {
      ...
      journalDesc: "Artículos educativos de calidad y recursos pedagógicos.",
